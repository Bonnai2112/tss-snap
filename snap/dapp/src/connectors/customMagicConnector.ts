import {
  ...
  export interface MagicCustomConnectorClientOptions {
    networkOptions: {
      rpcUrl: string
      chainId: number
    }
   ...
   */
  export interface CustomMagicConnectorConstructorArgs {
    actions: Actions
    options: MagicCustomConnectorClientOptions
    onError?: (error: Error) => void
  }
  
  export class CustomMagicConnector extends Connector {
    public provider?: RPCProviderModule & AbstractProvider
    public magic?: Magic
    public chainId?: number
    private eagerConnection?: Promise<void>
    private readonly options: MagicCustomConnectorClientOptions
  
    constructor({ actions, options, onError }: CustomMagicConnectorConstructorArgs) {
